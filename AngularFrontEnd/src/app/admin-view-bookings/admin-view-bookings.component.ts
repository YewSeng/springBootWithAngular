...
export class AdminViewBookingsComponent implements OnInit{
  ...
  selectedFilterCriteria: string = 'userUsername';
  searchTerm: string = '';
  ...
  filterBookings(): void {
    ...
    if (!this.searchTerm || this.searchTerm.trim() === '') {
        ...
        this.filteredBookings = this.bookingList.filter(bookingContact => {
            ...
            if (this.selectedFilterCriteria === 'userUsername') {
                filterValue = bookingContact.booking.user.username?.toLowerCase();
            } else if (this.selectedFilterCriteria === 'driverUsername') {
